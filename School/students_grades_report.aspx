<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="students_grades_report.aspx.cs" Inherits="suitespk.School.students_grades_report" %>
                        ...
                        success: function (data1) {
                            ...
                            for (var i = 0; i < studentId.length; i++) {
                                ...
                                for (var k = 0; k < subjectsId.length; k++) {
                                    ...
                                    stdMarksTd = stdMarksTd + '<td style="width: 7%;">' + stdSubjectMarks + '</td>'
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title col-10">Students Marks Sheet 
